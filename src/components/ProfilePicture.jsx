...
const ProfilePicture = ({avatar}) => {
    ...
    const handleDeleteImage = ()=>{
        ...
        if(window.confirm("Are you sure to delete your profile picture")){
            try {
  ...
  <div className='w-full flex items-center py-5 gap-x-4'>
       ...
       <button onClick={handleDeleteImage} className='border border-red-500 rounded-lg px-4 py-2 text-red-500'>Delete</button>
    </div>
  </>)
