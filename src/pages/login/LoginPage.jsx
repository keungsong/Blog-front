    ...
    <MainLayout>
      <section className='container mx-auto px-5 py-10'>
        <div className='w-full max-w-sm mx-auto'>
            <h1 className='text-center font-roboto font-bold text-2xl text-dark-hard'>Welcome</h1>
            <form onSubmit={handleSubmit(submitHandler)}>
                ...
                <Link to="/forget-password" className='font-semibold text-primary text-sm'>Forgot password?</Link>
                <button type='submit' disabled={!isValid || isLoading}
                className='bg-primary text-white font-bold text-lg py-4 px-8 w-full rounded-lg my-6 disabled:opacity-30 disabled:cursor-not-allowed'>Login</button>
                <p className='text-sm font-semibold text-[#5a7184]'>Don't have an account? 
                <Link to="/register" className='text-primary'> Register now</Link></p>
            </form>
        </div>
      </section>
    </MainLayout>
